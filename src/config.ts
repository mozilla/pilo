 ...
 *
 * Single file containing all config types, defaults, parsing, and management.
 * FIELDS object is the single source of truth for all config metadata.
 */
...
// =============================================================================
// CONFIG_SCHEMA - Array format for backward compatibility
// =============================================================================
...
export const CONFIG_SCHEMA: ConfigField[] = (Object.keys(FIELDS) as ConfigKey[]).map((key) => {
  ...
  return {
    ...
    // Map new field names to old interface names for compatibility
    cliOption: field.cli,
    cliShortOption: field.cliShort,
    envVars: field.env,
  } as ConfigField;
});
