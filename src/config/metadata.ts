/**
 * CLI and Environment Variable Metadata
 *
 * Defines how config fields map to CLI options and environment variables.
 * Types and defaults come from schema.ts (Zod is the single source of truth).
 */
...
/** Metadata for a config field (CLI options, env vars, etc.) */
...
// =============================================================================
// CONFIG_SCHEMA - Combines Metadata with Zod-Derived Types
// =============================================================================
