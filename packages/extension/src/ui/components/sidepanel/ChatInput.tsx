    ...
    <div className="border-t border-border px-3 py-2">
      ...
      >
        <textarea
          ...
          rows={1}
          className="flex-1 resize-none bg-transparent py-0 text-[13px] leading-normal text-foreground placeholder:text-muted-foreground focus:outline-none disabled:opacity-50"
